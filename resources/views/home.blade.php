  ...
  <div class="container-h">
    <div class="hero">
      <div class="hero-content">
        ...
        <p class="">Brindamos soluciones confiables y eficientes, garantizando resultados óptimos para cualquier tipo de avería</p>
        <p class="">Experiencia en marcas líderes como Fanuc, Mitsubishi, ABB y KUKA</p>
    ...
    <div class="apartado4h">
      ...
      <div class="apartado4hsol">
        <div class="formaciona4h">
          <div class="apartado4hp1">
            <img src="img/formacionb.png" alt="formación">
          </div>
          <div>
            <h4>Formación</h4>
        ...
        <div class="mantenimientoa4h">
          <div class="apartado4hp2">
            <img src="img/mantenimientob.png" alt="mantenimiento">
          </div>
          <div>
        ...
        <div class="ingenieriaa4h">
          <div class="apartado4hp3">
            <img src="img/ingenieriab.png" alt="ingenieria">
          </div>
          <div>
            <h4>Ingeniería</h4>
        ...
        <div class="automatizaciona4h">
          <div class="apartado4hp4">
            <img src="img/automatizacionb.png" alt="automatizacion">
          </div>
          <div>
